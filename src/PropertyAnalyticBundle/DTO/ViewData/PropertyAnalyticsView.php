...
namespace App\PropertyAnalyticBundle\DTO\ViewData;

use Swagger\Annotations as SWG;

/**
 * Represent the output response of PropertyAnalytics Entity.
 *
 * @SWG\Definition(definition="PropertyAnalytics")
 */
class PropertyAnalyticsView
{
    /**
